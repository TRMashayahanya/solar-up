...
export const themeCss =
  ...
  ".quote-page--compact{flex:1;min-height:0;display:flex;flex-direction:column;padding:0;width:100%;max-width:100%;min-width:0;height:100%;box-sizing:border-box}" +
  ".quote-page--compact .quote-page__content{position:relative;z-index:2;flex:1;min-height:0;display:flex;flex-direction:column;gap:0;padding:0 2px;overflow:hidden;width:100%;max-width:100%;min-width:0;box-sizing:border-box}" +
  ...
  ".quote-page__scroll{position:relative;z-index:1;flex:1;min-height:0;overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain;scroll-behavior:smooth;display:flex;flex-direction:column;gap:clamp(8px,1.6vh,12px);padding:2px 2px 4px;scrollbar-gutter:stable;min-width:0;max-width:100%;box-sizing:border-box}" +
  ...
  ".quote-checkout-dock{position:relative;z-index:2;flex-shrink:0;margin-top:auto;padding:6px 4px calc(52px + env(safe-area-inset-bottom,0px));display:flex;flex-direction:column;gap:5px;border-top:1px solid var(--border);background:linear-gradient(180deg,transparent 0%,var(--card-bg) 16%);backdrop-filter:blur(14px) saturate(1.12);-webkit-backdrop-filter:blur(14px) saturate(1.12);box-shadow:0 -6px 22px rgba(0,0,0,.04);width:100%;box-sizing:border-box;transition:padding .55s cubic-bezier(.22,1,.36,1),background .55s ease,border-color .55s ease,box-shadow .55s ease}" +
  ".quote-checkout-bar,.quote-checkout-dock{position:relative;flex-shrink:0;margin-top:auto}" +
  ".quote-page--ready .quote-checkout-dock{flex:0 0 auto;display:flex;flex-direction:column;justify-content:flex-start;align-items:stretch;min-height:0;margin-top:0;padding:clamp(8px,2vh,16px) 8px calc(52px + env(safe-area-inset-bottom,0px));border-top:none;background:transparent;box-shadow:none;backdrop-filter:none;-webkit-backdrop-filter:none;animation:quoteReadyDockCenter .68s cubic-bezier(.22,1,.36,1) both}" +
  ...
  "@media (min-height:740px){.quote-page--ready .quote-checkout-dock{flex:1 1 auto;justify-content:center;padding:clamp(14px,4.5vh,36px) 8px calc(52px + env(safe-area-inset-bottom,0px))}}" +
  "@media (max-height:700px){.quote-page--needs-install .quote-install-section--premium{justify-content:flex-start}.quote-page__scroll{gap:6px}.quote-page__mast{padding-bottom:6px}.quote-install-section--premium{padding:9px 12px 10px;gap:7px}.quote-loc-field .location-map-canvas,.quote-loc-field .location-map-iframe{min-height:clamp(88px,14vh,120px);max-height:20vh}}" +
  "@media (max-height:580px){.quote-page--ready .quote-page__scroll{max-height:42dvh;overflow-y:auto;-webkit-overflow-scrolling:touch}.quote-page--needs-install .quote-page__scroll{max-height:50dvh}}" +
  "@media (max-width:430px){.quote-page__mast{padding:2px 0 8px;column-gap:6px}.quote-page-header-brand{gap:8px}.quote-flow-steps{padding:2px 0 0}.quote-flow-step{gap:3px;min-width:0}.quote-flow-step-label{font-size:8px;max-width:4.8em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.quote-flow-steps-line{min-width:6px;max-width:24px;margin:0 2px}.quote-package-card--strip{grid-template-columns:minmax(0,1fr) auto;grid-template-rows:auto auto;gap:3px 8px;padding:8px 10px}.quote-package-strip-label{align-self:end}.quote-package-strip-copy{grid-column:1;grid-row:2}.quote-package-strip-price{grid-column:2;grid-row:1/span 2;align-self:center;font-size:.98rem}.quote-install-confirmed{grid-template-columns:auto 1fr;grid-template-rows:auto auto;gap:6px 10px;padding:10px 12px}.quote-install-confirmed-change{grid-column:1/-1;justify-self:stretch;text-align:center;width:100%;margin-top:2px}.quote-checkout-dock-cta{flex-wrap:wrap;row-gap:4px;justify-content:center;min-height:44px;padding:9px 12px}.quote-checkout-dock-cta-main{justify-content:center;flex:1 1 100%;min-width:0;font-size:13px}.quote-checkout-dock-cta-price{flex:0 0 auto;font-size:1rem}.quote-checkout-dock-hint{font-size:9px;white-space:normal;line-height:1.3;max-height:2.6em;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.quote-install-head--compact .quote-install-title{font-size:clamp(.92rem,3.6vw,1.05rem)}}" +
  "@media (max-width:380px){.quote-page-header-title{font-size:1.08rem}.quote-package-name{font-size:1.12rem}.quote-checkout-total-amount{font-size:1.55rem}.quote-delivery-card--compact{padding:9px 10px!important}.delivery-mode-btn{padding:7px 4px}.delivery-mode-btn-label{font-size:10px}.quote-zone-input{font-size:16px!important}.quote-install-radius-badge{display:none}.quote-package-card--strip{padding:8px 10px}.quote-flow-step-label{font-size:7px;max-width:4.2em}.quote-checkout-dock{padding-bottom:calc(44px + env(safe-area-inset-bottom,0px))}.quote-page-header-end .theme-toggle-btn{width:32px;height:32px}}";
